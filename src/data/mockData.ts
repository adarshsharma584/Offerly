...
export const MERCHANTS = [
  { id: 'M001', name: 'Cafe Delight', category: 'food', city: 'Golaghat', distance: 0.7, isVerified: true, isAd: true, adTier: 'premium' as const, image: 'https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=400&h=200&fit=crop', rating: 4.7, address: 'MG Road, Golaghat', phone: '+91 98765 43210', status: 'approved' },
  { id: 'M002', name: 'Style Salon', category: 'saloon', city: 'Golaghat', distance: 0.9, isVerified: true, isAd: true, adTier: 'growth' as const, image: 'https://images.unsplash.com/photo-1521590832167-7bcbfaa6381f?w=400&h=200&fit=crop', rating: 4.3, address: 'AT Road, Golaghat', phone: '+91 98765 43211', status: 'approved' },
  { id: 'M003', name: 'Royal Restaurant', category: 'food', city: 'Golaghat', distance: 1.5, isVerified: true, isAd: true, adTier: 'starter' as const, image: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=400&h=200&fit=crop', rating: 4.5, address: 'Station Road, Golaghat', phone: '+91 98765 43212', status: 'approved' },
  { id: 'M004', name: 'Super Mart', category: 'shops', city: 'Golaghat', distance: 1.2, isVerified: true, isAd: false, adTier: null, image: 'https://images.unsplash.com/photo-1534723452862-4c874018d66d?w=400&h=200&fit=crop', rating: 4.0, address: 'Market Area, Golaghat', phone: '+91 98765 43213', status: 'approved' },
  { id: 'M005', name: 'Urban Fit Gym', category: 'gym', city: 'Golaghat', distance: 2.1, isVerified: true, isAd: false, adTier: null, image: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=400&h=200&fit=crop', rating: 4.2, address: 'GNB Road, Golaghat', phone: '+91 98765 43214', status: 'approved' },
  { id: 'M006', name: 'Fresh Mart', category: 'shops', city: 'Golaghat', distance: 1.8, isVerified: true, isAd: false, adTier: null, image: 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=400&h=200&fit=crop', rating: 4.1, address: 'Dergaon Road, Golaghat', phone: '+91 98765 43215', status: 'approved' },
  { id: 'M007', name: 'Tech Haven', category: 'electronics', city: 'Golaghat', distance: 3.4, isVerified: false, isAd: false, adTier: null, image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=400&h=200&fit=crop', rating: 3.8, address: 'Fancy Bazar, Golaghat', phone: '+91 98765 43216', status: 'pending' },
  { id: 'M008', name: 'Quick Wheels', category: 'services', city: 'Golaghat', distance: 2.8, isVerified: true, isAd: false, adTier: null, image: 'https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=400&h=200&fit=crop', rating: 4.0, address: 'NH 39, Golaghat', phone: '+91 98765 43217', status: 'approved' },
  { id: 'M009', name: 'MedPlus Pharmacy', category: 'pharmacy', city: 'Golaghat', distance: 0.5, isVerified: true, isAd: false, adTier: null, image: 'https://images.unsplash.com/photo-1576602976047-174e57a47881?w=400&h=200&fit=crop', rating: 4.4, address: 'Hospital Road, Golaghat', phone: '+91 98765 43218', status: 'approved' },
  { id: 'M010', name: 'Trendy Fashion', category: 'fashion', city: 'Golaghat', distance: 1.0, isVerified: true, isAd: true, adTier: 'growth' as const, image: 'https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?w=400&h=200&fit=crop', rating: 4.1, address: 'City Center, Golaghat', phone: '+91 98765 43219', status: 'approved' },
];
