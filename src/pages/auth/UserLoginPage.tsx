...
export default function UserLoginPage() {
  ...
  return (
    ...
    >
      ...
      <div className="flex-[0_0_45%] md:flex-[0_0_50%] md:min-h-screen flex flex-col items-center justify-center relative overflow-hidden gradient-hero">
        <div
        ...
        >
          ...
          <div className="hidden md:flex gap-6 mt-10">
            {[
              ...
              <div
                key={s.label}
                className="bg-white/10 backdrop-blur-xl rounded-2xl px-5 py-3 border border-white/10 text-center"
              >
        ...
        <div
          className="float-anim absolute bottom-20 left-16"
      ...
      {/* Form — right on desktop, bottom sheet on mobile */}
      <div className="flex-1 bg-white rounded-t-[28px] md:rounded-none -mt-6 md:mt-0 relative z-10 flex items-start md:items-center justify-center shadow-[0_-8px_40px_rgba(0,0,0,0.12)] md:shadow-none">
        <div className="w-full max-w-[420px] px-6 md:px-10 pt-8 md:pt-0 pb-10">
          ...
          >
            ...
            <h2 className="font-display font-bold text-[22px] md:text-[28px] text-app-text mb-1">
              Log in or sign up
            </h2>
            ...
            <label className="flex items-center gap-2 mt-3 mb-5 cursor-pointer">
              <div
                ...
                className={`w-5 h-5 rounded-md border-2 flex items-center justify-center transition-all ${
                  remember
                    ? 'bg-green-700 border-green-700 shadow-glow'
                    : 'border-app-border'
                }`}
              >
